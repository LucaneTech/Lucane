...
const HeroSection: React.FC = () => {
  return (
    <section className="relative flex flex-col items-center justify-center text-center text-gray-700 px-4 overflow-hidden mt-12 ">
      {/* Tagline */}
      <div className="flex flex-row items-center justify-center md:gap-2.5 mb-6 border border-gray-500/30 rounded-full bg-gray-300/15  p-2 text-sm text-gray-800 backdrop-blur-md">
