...
const AllProjects :React.FC = ()=>{
  return(
    <>
     ...
     <ProjectSection projects={allProjects} title="Projets Portfolio" description="De l’idée au produit fini, nos projets incarnent l’agilité et l’audace. Nous construisons des solutions numériques qui transforment les ambitions en impact réel."/>
