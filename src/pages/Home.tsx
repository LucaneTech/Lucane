...
const Home: React.FC = () => {
  return (
    <div className="mt-32 md:mt-48">
      ...
      <section className="flex flex-col items-center justify-center mx-auto w-full text-center rounded-xl py-20 md:py-24 bg-[#008080]  dark:bg-gray-900 md:mt-20 px-4 md:px-0">
